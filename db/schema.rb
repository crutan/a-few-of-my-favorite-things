...
ActiveRecord::Schema[7.0].define(version: 2022_05_31_004356) do
  ...
  create_table "list_things", force: :cascade do |t|
    t.bigint "list_id", null: false
    t.bigint "thing_id", null: false
    t.integer "position"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["list_id"], name: "index_list_things_on_list_id"
    t.index ["thing_id"], name: "index_list_things_on_thing_id"
  end
  ...
  add_foreign_key "list_things", "lists"
  add_foreign_key "list_things", "things"
